...
function buildVideoList()
{
   $.ajax({
		...
		if (window.confirm("Deseja excluir este vídeo?"))
		{
			...
			{
				$('#video').html('<object width="320" height="240" type="application/x-shockwave-flash" data="http://releases.flowplayer.org/swf/flowplayer-3.2.7.swf"><param name="movie" value="http://releases.flowplayer.org/swf/flowplayer-3.2.7.swf" /><param name="allowfullscreen" value="true" /><param name="flashvars" value="config={\'clip\' : { \'url\' : \'' + $(this).attr("rel") + '\', \'autoPlay\' : true, \'autoBuffering\' : true } }" /></object>');
			} 
			else 
			{
