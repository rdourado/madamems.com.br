$(document).ready(function() 
{
	...
	var paginate = function()
	{
		...
		$(".content-list li").click(function(){
			...
			{
				$('#video').html('<object width="610" height="460" type="application/x-shockwave-flash" data="http://releases.flowplayer.org/swf/flowplayer-3.2.7.swf"><param name="movie" value="http://releases.flowplayer.org/swf/flowplayer-3.2.7.swf" /><param name="allowfullscreen" value="true" /><param name="flashvars" value="config={\'clip\' : { \'url\' : \'' + $(this).attr("rel") + '\', \'autoPlay\' : true, \'autoBuffering\' : true } }" /></object>');
			} 
			else 
			{
